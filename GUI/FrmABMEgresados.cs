...
namespace GUI
{
    public partial class FrmABMEgresados : Form
    {
        #region Variables
        ...
        #region Carga
        public FrmABMEgresados()
        {
            InitializeComponent();
        }

        private void FrmABMEgresados_Load(object sender, EventArgs e)
        {
            Cargar();
        }
        ...
        private void dgvAlumnos_SelectionChanged(object sender, EventArgs e)
        {
            if (cargado)
            {
                ...
                idEgresado = Convert.ToInt32(dtAlumno.Rows[index].ItemArray[2].ToString());

                //Llena los textbox
                tbNombres.Text = dtAlumno.Rows[index].ItemArray[3].ToString();
                tbApellidos.Text = dtAlumno.Rows[index].ItemArray[4].ToString();
                tbCorreo.Text = dtAlumno.Rows[index].ItemArray[5].ToString();
                tbDireccion.Text = dtAlumno.Rows[index].ItemArray[6].ToString();
                tbNacionalidad.Text = dtAlumno.Rows[index].ItemArray[9].ToString();
                tbNumDocumento.Text = dtAlumno.Rows[index].ItemArray[8].ToString();
        ...
        private void FrmABMEgresados_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        #endregion
